...
public class OrientationScrollView extends RelativeLayout {
    ...
    public OrientationScrollView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public OrientationScrollView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void setViewPager(final Context context, String[] titles, ViewPager viewPager
            ...
            , final int txtSelectedSize, final int widOffsets, boolean smoothScroll
            , int splilinecolor, final float splilinewidth, float topoffset
            , float bottomoffset, final int titlewidth) {
